...
type SubjectService interface {
	...
	CreateAndGetSubject(subject *domain.Subject) (*domain.Subject, *apperrors.Error)
	GetByNameAndCourse(name string, course, period byte) (*domain.Subject, *apperrors.Error)
